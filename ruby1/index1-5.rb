...
# このメソッドは、打ち込まれた値（num）の平方根までの値全てを使って割り算の余りを出力し、結果を求めている
# なぜ平方根までか？？？

# ⇨　例えば、素数11を、１１の平方根までの値で割り算していく
# 　　１１の平方根は「約3」
# 　　11　％　1　＝　11あまり0
# 　　11　％　2　＝　5あまり
# 　　11　％　3　＝　3あまり2　　平方根の値で割り算している部分。これ以降に注目
# 　　11　％　4　＝　2あまり3
# 　　11　％　5　＝　2あまり1
# 　　11　％　6　＝　1あまり5

# このように、３以降の値は3を超えることがない。よって、その値の平方根で割るところまで求めると結果は絞られる。

# それまでに＝＝0にならない限り、打ち込んだ値numは素数であると証明できる。
...
#     i は2〜num(打ち込まれた数値の平方根までの数値)を連続して出力する
#     早期タイミングで==0になった場合は、すぐに繰り返しはストップする。
